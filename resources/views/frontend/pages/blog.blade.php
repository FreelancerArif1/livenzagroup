...
@section('content')
    <main id="blog_page">
        ...
        <!-- Blog List -->
        <div class="page-blog section-padding">
            <div class="container">
                                ...
                                <div class="card-blog radius18">
                                    <div class="card-blog-top">
                                        <div class="card-blog-meta">
                                            <div class="card-blog-meta-item text text-15">
                                        ...
                                        <h2 class="card-blog-heading heading text-20">
                                            <a href="/news/{{ $item->slug }}" class="heading text-20">
                                                {{ $item->title }}
                                            </a>
                                        </h2>
                                    </div>
                                    <a class="card-blog-bottom" href="/news/{{ $item->slug }}" aria-label="Blog details">
                                        <div class="media">
                                            <img src="{{ $item->image }}" alt="blog image" width="1000" height="707"
                                                loading="lazy">
                                        </div>
                                        <div class="buttons">
